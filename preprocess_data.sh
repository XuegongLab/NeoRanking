...
PYTHONPATH=$NEORANKING_CODE python3 DataWrangling/CalcCatEncodings.py -pt neopep -ds NCI_train --isopath "${isopath}"
PYTHONPATH=$NEORANKING_CODE python3 DataWrangling/CalcCatEncodings.py -pt mutation -ds NCI_train --isopath "${isopath}"
